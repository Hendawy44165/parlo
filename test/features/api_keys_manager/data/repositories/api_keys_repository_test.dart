...
class MockApiKeysLocalDataSource extends Mock implements ApiKeysLocalDataSource {}
  ...
  group('ApiKeysRepository', () {
    ...
    group('getAllApiKeys', () {
      test('should return a list of ApiKeyEntity', () async {
        // Arrange
        when(() => mockDataSource.getAllApiKeys()).thenAnswer((_) async => [tApiKeyModel]);
        // Act
    ...
    group('addNewApiKey', () {
      test('should add a new api key', () async {
        ...
        when(() => mockDataSource.saveApiKeys(any())).thenAnswer((_) async => {});
        // Act
      ...
      test('should throw an exception when adding a duplicate api key', () async {
        // Arrange
        when(() => mockDataSource.getAllApiKeys()).thenAnswer((_) async => [tApiKeyModel]);
        // Act & Assert
    ...
    group('deleteApiKey', () {
      ...
      test('should throw an exception when deleting a non-existent api key', () async {
        // Arrange
        when(() => mockDataSource.getAllApiKeys()).thenAnswer((_) async => []);
        // Act & Assert
