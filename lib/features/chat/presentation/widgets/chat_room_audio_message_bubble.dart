...
class ChatRoomAudioMessageBubble extends StatelessWidget {
  const ChatRoomAudioMessageBubble({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final Color bubbleColor =
        message.isMine
            ? ColorsManager.primaryPurple.withValues(alpha: 0.9)
            : ColorsManager.lightNavyBlue;
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyleManager.dimmed12Regular.copyWith(
